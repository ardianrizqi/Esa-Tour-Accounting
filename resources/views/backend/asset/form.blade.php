                    ...
                    <div class="card-body">
                        <div class="row">
                            <form action="{{ route('backend.asset.store') }}" method="POST"
                                ...
                                <input type="hidden" id="asset_id" name="asset_id" @isset($data) value="{{ $data->id }}"
                                    @endisset>
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label" for="modalEditUserFirstName">Nama Modal</label><span
                                        style="color: red;"> *</span>
                                    <input type="text" id="name" name="name" class="form-control"
                                        placeholder="Ketik Nama Modal" required @isset($data) value="{{ $data->name }}" @endisset/>
                                </div>
