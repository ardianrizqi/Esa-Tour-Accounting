...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <input type="hidden" id="deposit_id" value="{{ $id }}">

            <div class="card-datatable table-responsive pt-0">
                <table id="history-table" class="datatables-basic table">
                    <thead>
                        <tr>
                            <th>No</th>
...
@push('js')
    <script src="{{ asset('assets/js/backend/history_deposit.js') }}"></script>
@endpush
