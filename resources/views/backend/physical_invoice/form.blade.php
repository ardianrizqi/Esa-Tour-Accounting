        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row">
                            <form action="{{ route('backend.physical_invoice.store') }}" method="POST"
                                enctype="multipart/form-data" class="row g-3">
                                @csrf

                                <input type="hidden" id="physical_invoice_id" name="physical_invoice_id" @isset($data) value="{{ $data->id }}"
                                    @endisset>
                                ...
                                <div class="col-12 col-md-12">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control"
                                        placeholder="Ketik Nama" required @isset($data)
                                        value="{{ $data->name }}" @endisset />
                                </div>

                                
                                <div class="col-12" style="display: flex; justify-content: flex-end; margin-top: 5%;">
                                    <a href="{{ route('backend.physical_invoice.index') }}"
