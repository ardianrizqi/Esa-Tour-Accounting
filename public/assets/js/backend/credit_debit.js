$(function () {
    var table = $('#credit-debit-table'),
        dt_basic;

    if (table.length) {
        dt_basic = table.DataTable({
            ajax: "credit-debit/data",
            dataSrc: 'data',
            columns: [
                {
                    data: null,
                ...
                { responsivePriority: 3, targets: 3 },
                {
                    ...
                    render: function (data, type, full, meta) {
                      return (
                        ...
                        // '</ul>' +
                        // '</div>' +
                        '<a href="credit-debit/edit/'+ full.id + '" class="btn btn-sm btn-icon item-edit"><i class="text-primary ti ti-pencil"></i></a>'+
