$(function () {
    var table = $('#physical-invoice-table'),
        dt_basic;

    if (table.length) {
        dt_basic = table.DataTable({
            ajax: "physical-invoice/data",
            dataSrc: 'data',
            columns: [
                {
                    data: null,
            ...
            columnDefs: [
                ...
                { responsivePriority: 2, targets: 2 },
                {
                    ...
                    render: function (data, type, full, meta) {
                      return (
                        '<a href="physical-invoice/edit/'+ full.id + '" class="btn btn-sm btn-icon item-edit"><i class="text-primary ti ti-pencil"></i></a>'+
